...
while futureclose != 250:
    ...
    averagefinalchangedrankedholding = mean(finalchangeholding)
    print(averagefinalchangedrankedholding)
    print('')
    ...
    while holdingiterator != stocksholding:
        ...
        if averagefinalchangedranked < 0:
            ...
            investmentchangeindex = averagefinalchangedrankedholding * investments - investments
            investmentchange = abs(investmentchange)
            investmentchangeindex = abs(investmentchangeindex)
            total = investmentchange + investmentchangeindex
            portfoliolist.append(total)
...
print(stdev)
pchange = (summedportfolio - portfoliobackteststart) / portfoliobackteststart * 100
print(pchange)
